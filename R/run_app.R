#' Run the app
#'
#' Initiate an instance of the 'mintEMU' app. If the current context is interactive,
...
run_mintEMU_app <- function() {

  if (interactive()) {

    shiny::runApp(appDir = system.file("mintEMUapp",
                                package = "mintEMU"))

  } else {

    shiny::shinyAppDir(appDir = system.file("mintEMUapp",
                                     package = "mintEMU"))
