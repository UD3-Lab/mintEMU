...
#     author_firstname = c("Kurt \n", "Oscar", "Ken"),
#     author_surname = c("Vonnegut", "Wilde", "Kesey"),
#     author_firstname2 = c("Kilgore", "", ""),
#     author_surname2 = c("Trout", "", "Bromden"),
#     title = c(
#       "Breakfast of Champions",
#       "The Picture of Dorian Gray",
#       "One Flew Over the Cuckoo's Nest"
...
#     author_firstname = c("Kurt \n", "Oscar", "Ken"),
#     author_surname = c("Vonnegut", "Wilde", "Kesey"),
#     author_firstname2 = c("Kilgore", NA, NA),
#     author_surname2 = c("Trout", NA, "Bromden"),
#     title = c(
#       "Breakfast of Champions",
#       "The Picture of Dorian Gray",
#       "One Flew Over the Cuckoo's Nest"
...
test_that("short_words works correctly when input is a corpus",{

  text_input <- c("this is a short sentence.",
             "this is a slightly longer one",
             "one, two, three short sentences is not a lot"
             )

 expected_output <- data.frame(word = c('a', 'is', 'one', 'this', 'lot','not', 'two'),
                               n = c(3, 3, 2, 2 , 1, 1, 1)
                               )

 output <- short_words(text_input, scope = 'corpus')
