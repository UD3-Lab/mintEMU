...
# clean text
  emu_theses$text_clean <- emu_theses$text %>%
    ...
    str_replace_all(emu_theses$author_firstname[i], "") %>%   ### remove author first name
    str_replace_all(emu_theses$author_surname[i], "") %>%     ### remove author surname
    str_replace_all(emu_theses$title[i], "") %>%              ### remove title
