...
get_top_words_per_document(data = emu_words, title_col = "ID", top_n = 10)
```
...
emu_tf_idf <- emu_words |> 
  get_tf_idf(title_col = "ID", word_col = "word")
...
tidy_pmi <- get_pmi(emu, title_col = "ID", text_col = "text_clean")
```
