...
spacyr::spacy_parse(emu_bigrams$w_1)
data.frame(emu_bigrams$w_1, textstem::lemmatize_words(emu_bigrams$w_1))
...
example_lemma <-list()
for (i in 1:10) {
  example_lemma[[i]] <- extract_rand_window(emu_bigrams$w_1,10)
}
